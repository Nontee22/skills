...
Use these rules for every Java article extraction.
...
- Java keywords, JVM behavior, concurrency rules, memory visibility, GC behavior, class loading, bytecode, or reflection details;
...
- it is stable Java knowledge, or it has been checked against current official documentation/source material when version-sensitive.
